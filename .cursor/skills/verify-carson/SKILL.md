...
Feature ids: `editor-baseline`, `wreck-this-poster`, `layer-groups`, `component-instances`, `xerox-treatment`, `decay-marks`, `misprint-type-strips`, `export-png`, `variations-trail`.
